...
// Add tests for power
    describe('Power', function () {
        ...
        // Tests with exponential notation
        it('raises a number in exponential notation to a positive integer power', function (done) {
            request.get('/arithmetic?operation=power&operand1=2e1&operand2=3')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: 8000 });
                    done();
                });
        });

        it('raises a number in exponential notation to a negative integer power', function (done) {
            request.get('/arithmetic?operation=power&operand1=2e1&operand2=-3')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: 0.000125 });
                    done();
                });
        });

        it('raises a number in exponential notation to a zero power', function (done) {
            request.get('/arithmetic?operation=power&operand1=2e1&operand2=0')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: 1 });
                    done();
        ...
        it('raises zero to a zero power', function (done) {
